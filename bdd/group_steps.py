...
def verify_group_added(db, group_list, new_group):
    with pytest.allure.step('Then the new group list is equal to the list with the added group'):
...
def verify_group_deleted(app, db, random_group, non_empty_group_list, check_ui):
